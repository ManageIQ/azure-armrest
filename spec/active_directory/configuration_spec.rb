...
#
# Specs for the Azure::Armrest::ActiveDirectory::Configuration class.
########################################################################
require 'spec_helper'

describe Azure::Armrest::ActiveDirectoryConfiguration do
  let(:options) do
    {
  ...
  let(:singleton)      { Azure::Armrest::ActiveDirectoryConfiguration }
  ...
  before {
    setup_params
    allow_any_instance_of(described_class).to receive(:fetch_token).and_return(true)
  }
